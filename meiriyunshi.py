...
def get_today_fortune():
    ...
    request_data = {
        "model": "deepseek-chat",
        "messages": [{"role": "user", "content": "请你以毛泽东本人的身份、口吻与视角，写一篇纯文字励志小文章，字数不超过350字，无配图，适配图文文案风格，专门给二三十岁正处在低谷、陷入绝境的年轻人鼓劲打气、点燃希望、启迪智慧。硬性要求，语气亲切、幽默、轻松接地气，像长辈拉家常，不生硬、不教条，内容必须自然融入毛泽东经典诗词、语录，结合毛泽东青年求学、革命低谷的亲身经历，效果让人重燃信心、看清方向、获得力量，格式纯文字短文，篇幅适中，适合阅读传播。每次生成必须全新内容，轮换不同诗词、不同经历、不同切入点，绝不重复。"}],
        "temperature": 0.8,
        "max_tokens": 500
    }
    try:
