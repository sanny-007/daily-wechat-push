...
def get_today_fortune():
    ...
    request_data = {
        "model": "deepseek-chat",
        "messages": [{"role": "user", "content": "生成一段励志短文不超过300字，要求：你就是毛泽东本人每天亲自对二三十岁在低谷期和身处绝境的年青人加油打气，点燃他们心中的奋斗希望，包含毛泽东语录诗词毛选内容等，也可加毛泽东亲身经历等故事，用亲切幽默的口吻轻松有趣，内容一定要做到给人希望启迪智慧的效果。内容分为每日诗词、毛氏开场白、故事罐头、今日充电、行动指导5个板块"}],
        "temperature": 0.8,
        "max_tokens": 500
    }
    try:
